...
// Date        : Tue Mar 12 03:24:10 2024
// Host        : DESKTOP-0B86MCA running 64-bit major release  (build 9200)
// Command     : write_verilog D:/digital_design_diploma/projects/SPI/project_SPI_final.v
// Design      : SPI_wrapper
...
module SPI_wrapper
  ...
  (* CORE_GENERATION_INFO = "u_ila_0,labtools_ila_v6_00_a,{ALL_PROBE_SAME_MU=true,ALL_PROBE_SAME_MU_CNT=1,C_ADV_TRIGGER=false,C_DATA_DEPTH=1024,C_EN_STRG_QUAL=false,C_INPUT_PIPE_STAGES=0,C_NUM_OF_PROBES=4,C_PROBE0_TYPE=2,C_PROBE0_WIDTH=1,C_PROBE1_TYPE=0,C_PROBE1_WIDTH=1,C_PROBE2_TYPE=0,C_PROBE2_WIDTH=1,C_PROBE3_TYPE=0,C_PROBE3_WIDTH=1,C_TRIGIN_EN=0,C_TRIGOUT_EN=0,component_name=u_ila_0_CV}" *) 
